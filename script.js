...
// input id number
// counter div id counter as per div
// current next
function startCounter() {
    ...
    if(isNaN(number)) {
        ...
        clearInterval(countInterval);   // This is important for the condition 
        // when a counter is running and you entered a wrong input for a new counter
        return;
    }
